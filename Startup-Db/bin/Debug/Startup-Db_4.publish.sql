...
GO
PRINT N'Dropping [dbo].[FK_Outlet_CompanyId_RS]...';


GO
ALTER TABLE [dbo].[Outlets] DROP CONSTRAINT [FK_Outlet_CompanyId_RS];


GO
PRINT N'Dropping [dbo].[FK_Outlet_Group_RS]...';


GO
ALTER TABLE [dbo].[Outlets] DROP CONSTRAINT [FK_Outlet_Group_RS];
...
GO
ALTER TABLE [dbo].[Outlets] WITH NOCHECK
    ADD CONSTRAINT [FK_Outlet_CompanyId_RS] FOREIGN KEY ([Company_Id]) REFERENCES [dbo].[Company] ([Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[Outlets] WITH NOCHECK
    ADD CONSTRAINT [FK_Outlet_Group_RS] FOREIGN KEY ([Group_Id]) REFERENCES [dbo].[OutletGroup] ([Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[Outlets] WITH CHECK CHECK CONSTRAINT [FK_Outlet_CompanyId_RS];

ALTER TABLE [dbo].[Outlets] WITH CHECK CHECK CONSTRAINT [FK_Outlet_Group_RS];
