...
GO
PRINT N'Dropping [dbo].[Fk_OutletGroup_Company_RS]...';


GO
ALTER TABLE [dbo].[OutletGroup] DROP CONSTRAINT [Fk_OutletGroup_Company_RS];
...
GO
ALTER TABLE [dbo].[OutletGroup] WITH NOCHECK
    ADD CONSTRAINT [Fk_OutletGroup_Company_RS] FOREIGN KEY ([Company_Id]) REFERENCES [dbo].[Company] ([Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[OutletGroup] WITH CHECK CHECK CONSTRAINT [Fk_OutletGroup_Company_RS];
